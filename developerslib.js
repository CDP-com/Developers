...
function downloadApp()
{
   if ( installApp() )
   {
      location.href = "helloworldinstaller.exe";
   }
...
function runApp()
{
   ...
   {
      // demoResults();
      alert('Demo Message: Hello World from One-Click Apps!');
   }
   else
   {
...
{
   window.open( "http://snapback-apps.com/commune/2011/11/03/hello-world-user-developer-page/", "", "height=400,width=700,location=yes,menubar=yes,toolbar=yes,scrollbars=yes,resizable=yes" );
   // document.location.href = "http://factory.snapback-apps.com/wordpress/wp-content/plugins/autologin-guest/autologin.php?redirect_to=http://factory.snapback-apps.com/wordpress/helloworld/wp-admin/post.php%3Fpost=12%26action=edit";
}
